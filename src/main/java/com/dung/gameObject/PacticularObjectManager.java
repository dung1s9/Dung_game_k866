...
public class PacticularObjectManager {
    protected final List<ParticularObject> particularObjects;

    private GameWord gameWorld;

    public PacticularObjectManager(GameWord gameWorld){
    ...
    public ParticularObject getCollisionWidthEnemyObject(ParticularObject object){
        ...
        synchronized(particularObjects){
            for(int id = 0; id < particularObjects.size(); id++){
                ...
                if(object.getTypeTeam() != objectInList.getTypeTeam() &&
